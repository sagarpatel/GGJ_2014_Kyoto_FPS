...
public class PlayerController1 : MonoBehaviour {
	...
	void Update() {
		zPosition = Input.GetAxis("Horizontal") * moveSpeed;
		yPosition = Input.GetAxis("Vertical") * moveSpeed;
		...
		transform.position = new Vector3(currentZPosition, 0, currentYPosition);
	}
